...
import { CommentCreatedDomainEvent } from './events/comment.created.domain-event'
import { CommentDeletedDomainEvent } from './events/comment.deleted.domain-event'
import { CommentEntityCreationProps, CommentEntityProps, CommentUpdateTextProps } from './comment.types'
