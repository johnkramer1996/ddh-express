...
export default function associate() {
  ...
  UserModel.hasMany(CommentVoteModel, { as: 'comment_votes', sourceKey: 'id', foreignKey: 'comment_id' })

  PostModel.hasMany(PostVoteModel, { as: 'votes', sourceKey: 'id', foreignKey: 'post_id' })
  PostModel.hasMany(CommentModel, { as: 'comments', sourceKey: 'id', foreignKey: 'post_id' })
