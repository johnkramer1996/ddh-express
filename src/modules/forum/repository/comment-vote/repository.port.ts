...
export interface CommentVoteRepositoryPort extends RepositoryPort<CommentVoteEntity> {
  ...
  // Therefore, an aggregate can have only one repository object in terms of design constraints,
  // which is a repository named after the aggregate root. No other objects should be provided with repository objects.
