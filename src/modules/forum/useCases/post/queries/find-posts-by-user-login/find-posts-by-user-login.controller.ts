...
import { FindPostsByLoginQuery } from './find-posts-by-user-login.query'
...
import { FindPostsByLoginPaginatedQueryRequestDto } from './find-posts-by-user-login.request.dto'
