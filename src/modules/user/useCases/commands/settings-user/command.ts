...
import { UpdatePostServiceResponse as SettingsUserServiceResponse } from './service'
import fileUpload from 'express-fileupload'

export class SettingsUserCommand implements ICommand<SettingsUserServiceResponse> {
  ...
  constructor(props: SettingsUserCommand) {
