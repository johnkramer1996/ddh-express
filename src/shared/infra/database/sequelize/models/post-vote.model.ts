...
import { PostVoteModelAttributes, PostVoteModelCreationAttributes } from '@src/modules/forum/domain/entity/post-vote/post-vote-types'
import { MemberModel } from './member.model'

@injectable()
export class PostVoteModel extends Model<PostVoteModelAttributes, PostVoteModelCreationAttributes> {
  declare id: string
