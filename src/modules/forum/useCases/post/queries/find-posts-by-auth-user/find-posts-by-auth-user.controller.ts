...
import { FindPostByAuthUserPaginatedQueryRequestDto } from '@src/modules/forum/useCases/post/queries/find-posts-by-auth-user/find-posts-by-auth-user.request.dto'
